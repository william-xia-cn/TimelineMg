...
| Windows desktop portable | Active implementation target | `platforms/desktop-electron/`; package target `TimeWhere-0.3.4-win-portable.exe`; complete local app without Chrome extension dependency. |
