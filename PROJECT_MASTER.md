...
- Current Browser Extension WebDev repositioning remains deferred: `npm run webdev:extension:readiness` verifies the legacy MV3 shell has not become a WebDev replay endpoint or Cloudflare runtime client; Gate D is still required before defining or implementing the first ecosystem phase.
