...
- [x] Build&Test added `npm run webdev:desktop:readiness` as a Gate E readiness-only static check: it verifies Electron WebDev runtime mode, route guards, native preload bridge, docs, and packaging boundary without launching Electron, building a package, signing, notarizing, or distributing.
