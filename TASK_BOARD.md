...
- [x] Build&Test corrected the `0.3.0` macOS artifact target from superseded x64 zip to Universal zip and generated GitHub Actions artifact `TimeWhere-0.3.0-mac-universal.zip` with SHA256 `0541F177DFB5754C5145BC65582A08D5ED0A533F4FC24A01F92219DE14410A4E`; `v0.3.0` still needs to be moved to the final evidence commit.
