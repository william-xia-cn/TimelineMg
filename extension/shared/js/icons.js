...
function initIcons() {
    ...
    document.querySelectorAll('span.material-symbols-outlined, i.material-symbols-outlined').forEach(el => {
    ...
    document.querySelectorAll('[class*="ri-"]').forEach(el => {
    ...
    document.querySelectorAll('[class*="ms-"]').forEach(el => {
        const classes = el.className.split(' ');
        for (const cls of classes) {
