...
async function main() {
  ...
  try {
    ...
    await visible(page, 'Prod Dashboard renders projection', page.getByText('Today projection'));
    ...
    await visible(page, 'Prod Calendar renders date projection', page.getByText('Date projection', { exact: true }));
